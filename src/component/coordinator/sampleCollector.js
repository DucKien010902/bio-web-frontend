...
const SampleCollectorListPage = () => {
  ...
  return (
    <div style={{ padding: 24 }}>
      <h2>Danh sách nhân viên thu mẫu</h2>
      <Space style={{ marginBottom: 16 }}>
        <Select
          ...
          style={{ width: 160 }}
        >
          <Select.Option value="id">Tìm theo Mã NV</Select.Option>
...
export default SampleCollectorListPage;
