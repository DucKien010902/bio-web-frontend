...
const ShopeeProductCardMobile = ({ product, onClick }) => {
  return (
    <div className="product-card-wrappermobile">
      <div className="product-cardmobile" onClick={onClick}>
      ...
      <style>
        {`
          ...
          .product-card-wrappermobile:hover .view-detail {
            display: block;
          }
        `}
      </style>
...
export default ShopeeProductCardMobile;
